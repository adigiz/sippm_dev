...
@section('title', 'Tambah Riwayat Pertemuan Ilmiah')
@section('styles')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-block">
                    <h4 class="card-title"> Form Penambahan Riwayat Pertemuan Ilmiah</h4>
                    <form class="form" action="{{route('riwayat.pertemuan.store')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="input-group col-10">
                                <input type="date" class="form-control" placeholder="MM/DD/YYYY" name="tgl_pelaksanaan">
